...
public class AmmoPickup : MonoBehaviourPun
{
    ...
    public int cargadoresQueDa = 1;
    public float respawnTime = 60f;
    public float startupGraceTime = 1f;
    ...
    void Start()
    {
        ...
        // No se puede recoger al spawnear (evita auto-recogida)
    ...
    private void RPC_ConfirmPickup(int healedActorNumber)
    {
        ...
        if (PhotonNetwork.LocalPlayer.ActorNumber == healedActorNumber)
        {
            ...
            if (weapon != null)
            {
                weapon.cargadoresActuales += cargadoresQueDa;
                Debug.Log("Cargador recogido. Cargadores: " + weapon.cargadoresActuales);
            }
        }
